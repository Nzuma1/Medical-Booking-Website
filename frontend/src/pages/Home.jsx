        ...
        <div className="container">
          ...
          md:text-[60px] md:leading-[70px]"
                ...
                <p className="text__para">
                  ...
                  laboris nisi ut aliquip ex eas
                </p>
              ...
              >
                ...
                <div>
                  ...
                  <span className="w-[102px] h-2 bg-irisBlueColor rounded-full block mt-[-18px]"></span>
            ...
            <div className="flex gap-[30px] justifyy-end">
              <div>
                <img className="w-full" src={heroImg01} alt="doctor.png" />
              </div>
              <div className="mt-[30px]">
                ...
                />
                <img src={heroImg03} alt="doctor2.png" className="w-full" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            <div className="xl:w-[670px]">
              <h2 className="heading">
                Get virtual treatment <br /> anytyme
              </h2>
              ...
              <ul className="pl-4">
                ...
                <li className="text__para">
                  3. View our physicians who are expecting new patients, use the
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              ...
              <div
                className="w-[150px] lg:w-[240px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] 
              md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px] shadow-xl"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-[6px] lg:gap-3">
                    <p
                      className="text-[10px] leading-[10px] lg:text-[14px] lg:leading-5 
                ...
                <div
                  className="w-[65px] lg:w-[96px] rounded-full bg-[#CCF0F3] py-1 px-2 lg:py-[6px] lg:px-[10px]
